...
def extract_domain_entities(sample_texts):
    ...
    try:
        ...
        response = client.chat.completions.create(
            model=LLM_MODEL,
            messages=[
                {"role": "system", "content": "You are a bilingual (English/Arabic) expert in food and pharmaceutical domains. Extract entity categories and keywords from text. Please make sure that you analyze the arabic content in detail for entities extraction."},
